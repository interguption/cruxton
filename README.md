...
```
/plugin marketplace add interguption/cruxton
...
```
git clone https://github.com/interguption/cruxton
...
Download `cruxton-decision-records.zip` from the [latest release](https://github.com/interguption/cruxton/releases),
