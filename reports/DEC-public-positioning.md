...
confidence:    high
human_input:   true
human_crux:    "Pranav chose narrowness as the brand: Cruxton should own the decision layer agents are required to consult, with the human reasoning they cannot reconstruct at its center, rather than compete as another system that remembers everything."
...
- The choice to make narrowness the brand and human reasoning the center came from Pranav's adoption of the launch direction — `human-expertise`.
