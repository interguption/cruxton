...
*16 records · input-hash `5e686c7f440d22b4`. Generated by `scripts/decision_index.py` — do not edit; regenerate instead.*
...
**method** — `DEC-bootstrap-safety`, `DEC-cross-tool-pointer`, `DEC-decision-kinds`, `DEC-decision-record-identity`, `DEC-decisions-md-presentation`, `DEC-deterministic-artifacts`, `DEC-distribution-central-mutable-method`, `DEC-index-is-generated`, `DEC-organizing-frame-pace-layering`, `DEC-placement-by-binding-only`, `DEC-privacy-redaction`, `DEC-record-id-scheme`, `DEC-records-stay-put`, `DEC-strict-validation`, `DEC-why-has-three-layers`, `DEC-why-record-decisions`
