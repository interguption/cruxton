...
*18 records · input-hash `2c17665d84c73867`. Generated by `scripts/decision_index.py` — do not edit; regenerate instead.*
...
**method** — `DEC-bootstrap-safety`, `DEC-cross-tool-pointer`, `DEC-decision-kinds`, `DEC-decision-record-identity`, `DEC-decisions-md-presentation`, `DEC-deterministic-artifacts`, `DEC-distribute-as-plugin`, `DEC-distribution-central-mutable-method`, `DEC-index-is-generated`, `DEC-organizing-frame-pace-layering`, `DEC-placement-by-binding-only`, `DEC-privacy-redaction`, `DEC-record-id-scheme`, `DEC-records-stay-put`, `DEC-repo-is-its-own-marketplace`, `DEC-strict-validation`, `DEC-why-has-three-layers`, `DEC-why-record-decisions`
