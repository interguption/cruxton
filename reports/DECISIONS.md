...
*22 records · input-hash `b00828c19c31fbf8`. Generated by `scripts/decision_index.py` — do not edit; regenerate instead.*
...
- [`DEC-public-positioning`](DEC-public-positioning.md) **Cruxton is positioned as the repo-native decision layer agents must consult** · design/accepted · conf:high  
  _human crux:_ PS chose narrowness as the brand: Cruxton should own the decision layer agents are required to consult, with the human reasoning they cannot reconstruct at its center, rather than compete as another system that remembers everything.
